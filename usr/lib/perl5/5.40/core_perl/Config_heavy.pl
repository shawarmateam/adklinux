...
cf_by='builduser'
cf_email=''
cf_time='Sun Sep  1 11:21:17 UTC 2024'
charbits='8'
charsize='1'
chgrp=''
chmod='chmod'
...
config_arg1='-des'
config_arg10='-Dsitearch=/usr/lib/perl5/5.40/site_perl'
config_arg11='-Dvendorlib=/usr/share/perl5/vendor_perl'
config_arg12='-Dvendorarch=/usr/lib/perl5/5.40/vendor_perl'
...
config_arg19='-Dlddlflags=-shared -Wl,-O1 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now          -Wl,-z,pack-relative-relocs -flto=auto'
config_arg2='-Dusethreads'
config_arg20='-Dldflags=-Wl,-O1 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now          -Wl,-z,pack-relative-relocs -flto=auto'
config_arg21='-Dloclibpth=/usr/lib/db5.3'
config_arg22='-Dlocincpth=/usr/include/db5.3'
config_arg3='-Duseshrplib'
config_arg4='-Doptimize=-march=x86-64 -mtune=generic -O2 -pipe -fno-plt -fexceptions         -Wp,-D_FORTIFY_SOURCE=3 -Wformat -Werror=format-security         -fstack-clash-protection -fcf-protection         -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -g -ffile-prefix-map=/build/perl/src=/usr/src/debug/perl -flto=auto'
config_arg5='-Dprefix=/usr'
config_arg6='-Dvendorprefix=/usr'
config_arg7='-Dprivlib=/usr/share/perl5/core_perl'
config_arg8='-Darchlib=/usr/lib/perl5/5.40/core_perl'
...
incpath=''
incpth='/usr/lib/gcc/x86_64-pc-linux-gnu/14.2.1/include /usr/local/include /usr/lib/gcc/x86_64-pc-linux-gnu/14.2.1/include-fixed /usr/include'
inews=''
...
libsdirs=' /usr/lib /usr/lib/db5.3'
libsfiles=' libpthread.a libgdbm.so libdb.so libdl.a libm.so libcrypt.so libutil.a libc.so libgdbm_compat.so'
libsfound=' /usr/lib/libpthread.a /usr/lib/libgdbm.so /usr/lib/db5.3/libdb.so /usr/lib/libdl.a /usr/lib/libm.so /usr/lib/libcrypt.so /usr/lib/libutil.a /usr/lib/libc.so /usr/lib/libgdbm_compat.so'
libspath=' /usr/local/lib /usr/lib /usr/lib/db5.3'
...
locincpth='/usr/include/db5.3'
loclibpth='/usr/lib/db5.3'
...
phostname='uname -n'
pidtype='pid_t'
plibpth='/lib/x86_64-pc-linux-gnu/14.2.1 /lib/../lib /usr/lib/x86_64-pc-linux-gnu/14.2.1 /usr/lib/../lib /lib /usr/lib'
pmake=''
pr=''
prefix='/usr'
prefixexp='/usr'
...
ccflags_nolargefiles='-D_REENTRANT -D_GNU_SOURCE -fwrapv -fno-strict-aliasing -pipe -fstack-protector-strong -I/usr/include/db5.3 '
ldflags_nolargefiles='-Wl,-O1 -Wl,--sort-common -Wl,--as-needed -Wl,-z,relro -Wl,-z,now -Wl,-z,pack-relative-relocs -flto=auto -fstack-protector-strong -L/usr/lib/db5.3'
